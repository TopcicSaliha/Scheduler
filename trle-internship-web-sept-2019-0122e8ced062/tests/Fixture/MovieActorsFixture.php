 ...
 * MovieActorsFixture
 */
class MovieActorsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'movie_actors_ibfk_1' => ['type' => 'foreign', 'columns' => ['actors_id'], 'references' => ['actors', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'movie_actors_ibfk_2' => ['type' => 'foreign', 'columns' => ['movies_id'], 'references' => ['movies', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_by' => 1,
                'updated_by' => 1,
                'modified' => '2019-10-09 11:15:20',
                'created' => '2019-10-09 11:15:20'
            ],
        ];
        parent::init();
    }
