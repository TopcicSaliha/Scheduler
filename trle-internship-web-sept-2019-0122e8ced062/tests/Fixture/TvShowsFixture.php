...
class TvShowsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cover' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_by' => 1,
                'updated_by' => 1,
                'modified' => '2019-10-09 11:12:25',
                'created' => '2019-10-09 11:12:25'
            ],
        ];
        parent::init();
    }
